...
public class UserDaoImp implements UserDao {
    ...
    public UserEntity GetUserInfo(String username) {
        ...
        userEntity=session.selectOne("com.ctrip.order.dao.UserDao.GetUserInfo",username);
        return userEntity;
    }

    public int register(UserEntity userEntity) {
        int result= session.insert("com.ctrip.order.dao.UserDao.register",userEntity);
        session.commit();
        return result;
    }
